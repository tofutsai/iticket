    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, e) {
                $('#ListBody').append(`<tr data-id="${e.CommentID}" class="${e.IsBaned ? 'text-danger' : ''}" style="cursor: pointer">
                    ...
                    <td class="pt-2 pb-1">
                        <img src="/images/Activity/CommentStar/${e.Score > 0 ? 'chngstar.gif' : 'star.gif'}" style="width: 24px; margin: 1px;">
                        <img src="/images/Activity/CommentStar/${e.Score > 1 ? 'chngstar.gif' : 'star.gif'}" style="width: 24px; margin: 1px;">
                        <img src="/images/Activity/CommentStar/${e.Score > 2 ? 'chngstar.gif' : 'star.gif'}" style="width: 24px; margin: 1px;">
                        <img src="/images/Activity/CommentStar/${e.Score > 3 ? 'chngstar.gif' : 'star.gif'}" style="width: 24px; margin: 1px;">
                        <img src="/images/Activity/CommentStar/${e.Score > 4 ? 'chngstar.gif' : 'star.gif'}" style="width: 24px; margin: 1px;">
                    </td>
                    <td class="pt-2 pb-1">${e.Date.split(' ')[0]}&nbsp;&nbsp;&nbsp;${e.Date.split(' ')[1]}</td>
                    <td class="pt-2 pb-1">${e.IsBaned ? '已隱藏' : '未隱藏'}</td>
